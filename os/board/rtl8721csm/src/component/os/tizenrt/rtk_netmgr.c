...
#include <tinyara/net/if/wifi.h>
#if 1
wifi_utils_result_e wifi_netmgr_utils_init(struct netdev *dev);
wifi_utils_result_e wifi_netmgr_utils_deinit(struct netdev *dev);
wifi_utils_result_e wifi_netmgr_utils_scan_ap(struct netdev *dev, void *arg);
wifi_utils_result_e wifi_netmgr_utils_connect_ap(struct netdev *dev, wifi_utils_ap_config_s *ap_connect_config, void *arg);
wifi_utils_result_e wifi_netmgr_utils_disconnect_ap(struct netdev *dev, void *arg);
wifi_utils_result_e wifi_netmgr_utils_get_info(struct netdev *dev, wifi_utils_info_s *wifi_info);
wifi_utils_result_e wifi_netmgr_utils_start_sta(struct netdev *dev);
wifi_utils_result_e wifi_netmgr_utils_start_softap(struct netdev *dev, wifi_utils_softap_config_s *softap_config);
wifi_utils_result_e wifi_netmgr_utils_stop_softap(struct netdev *dev);
wifi_utils_result_e wifi_netmgr_utils_set_autoconnect(struct netdev *dev, uint8_t check);
#endif
